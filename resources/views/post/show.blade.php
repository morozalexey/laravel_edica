    ...
    <main class="blog-post">
        <div class="container">
            ...
            <p class="edica-blog-post-meta" data-aos="fade-up"
               data-aos-delay="200">{{$date->translatedFormat('F')}} {{$date->day}} {{$date->year}}  {{$date->format('H:i')}}
                        ...
                        <form action="{{route('post.comment.store', $post->id)}}" method="post">
                            ...
                            <div class="row">
                                <div class="form-group col-12" data-aos="fade-up">
                                    ...
                                    <textarea name="message" id="message" class="form-control" placeholder="Ваш комментарий" rows="10"></textarea>
                                </div>
                            </div>
                            <div class="row">
